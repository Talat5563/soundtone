...
/**
 * Created by talat on 16/04/17.
 */

public class AppRater {

    private final static String APP_TITLE = "SoundTone";// App Name
    private final static String APP_PNAME = "com.talat.soundtone";// Package Name
    ...
    private static final String TAG = "SOUNDTONE-AppRater";

    public static void app_launched(Context mContext) {
        Log.i(TAG,"app lunched");
        ...
        Log.i(TAG,"lunch count = " + launch_count);
